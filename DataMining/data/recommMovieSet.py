...
def getreview(url, genrelist, main_content, i):
        ...
        if genrelist[0] == 'Action':
                a = i
                if os.path.isdir('recommSet\ ' + movie_title) == False:
                        os.makedirs('recommSet\ ' + movie_title)
                ...
                for item in broth.select(".review-container"):
                        ...
                        file4 = io.open('recommSet\ ' + movie_title + '\\ ' + x + '.txt', 'w',
                                        encoding="utf-8")
                        file4.write("{}\n".format(movie_title))
                        file4.write("{}\n".format(review))
                        file4.close()
                        a = a + 1
                """if a < 40:
                        shutil.rmtree('recommSet\\action\ ' + movie_title)"""
                ...
                for item in broth.select(".review-container"):
                        ...
                        a = a + 1
                """if a < 40:
                        shutil.rmtree('recommSet\\animation\ ' + movie_title)"""
                ...
                for item in broth.select(".review-container"):
                        ...
                        a = a+1
                """if a < 40:
                        shutil.rmtree('recommSet\comedy\ ' + movie_title)"""
                ...
                for item in broth.select(".review-container"):
                        ...
                        a = a + 1
                """if a < 40:
                        shutil.rmtree('recommSet\horror\ ' + movie_title)"""
        return a
...
os.makedirs('recommSet')
filepath = 'recommendationlist.txt'
